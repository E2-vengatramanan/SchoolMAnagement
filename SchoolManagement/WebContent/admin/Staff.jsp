        ...
        <div id="editstudentDiv" style="text-align: center;display:none;">
            <form class="editstudentform" id="editStudent" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="studentFname1" id="studentFname1" placeholder="Ex:venkat"
                        autocomplete="off">
                    <br><br>
                    <label id="lab">Student Last Name</label>
                    <input type="text" name="studentLname1" id="studentLname1" placeholder="Ex:Ramanan"
                        autocomplete="off">
                    <br><br>
                    <label id="lab">Class Name</label>
                    <input type="text" name="className1" placeholder="Ex:Computer Science" id="className1"
                        autocomplete="off">
                    <br><br>
                    <label id="lab">MobileNumber</label>
                    <input type="text" name="studentMob1" placeholder="Ex:9876543210" id="studentMob1"
                        autocomplete="off">
                    <br><br>
                    <label id="lab">MailId</label>
                    <input type="text" name="studentMail1" placeholder="Ex:ram123@gmail.com" autocomplete="off"
                        id="studentMail1">
                    <br><br>
