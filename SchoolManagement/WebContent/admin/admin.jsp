    ...
    <body id="adminbody">
        ...
        <div id="addstudentDiv" style="display: none;text-align: center;">
            <form class="addstudentform" id="addStudent" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="studentFname" id="studentFname" value="" placeholder="Ex:venkat"
                        autocomplete="off" required>
                    <br><br>
                    <label id="lab">Student Last Name</label>
                    <input type="text" name="studentLname" id="studentLname" value="" placeholder="Ex:Ramanan"
                        autocomplete="off" required>
                    <br><br>
                    <label id="lab">Class Name</label>
                    <input type="text" name="className" placeholder="Ex:Computer Science" value="" id="className"
                        autocomplete="off" required>
                    <br><br>
                    <label id="lab">MobileNumber</label>
                    <input type="text" name="studentMob" placeholder="Ex:9876543210" value="" id="studentMob"
                        autocomplete="off" required>
                    <br><br>
                    <label id="lab">MailId</label>
                    <input type="text" name="studentMail" placeholder="Ex:ram123@gmail.com" value="" autocomplete="off"
                        id="studentMail" required>
                    <br><br>
                    <label id="lab">Address</label>
                    <input type="text" name="studentAddress" id="studentAddress" value="" placeholder="Ex:Chennai">
                    <br><br>
                    <input class="btn btn-success" id="submitButton" type="submit" value="SAVE"
                        onclick="saveStudent(event)" style="margin-left: 0px;">
        ...
        <div id="editstudentDiv" style="text-align: center;display:none;">
            <form class="editstudentform" id="editStudent" method="post">
                ...
                <div class="form-group">
                    <label id="lab">Student First Name</label>
                    <input type="text" name="studentFname1" id="studentFname1" value="" placeholder="Ex:venkat"
                        autocomplete="off" required>
                    <br><br>
                    <label id="lab">Student Last Name</label>
                    <input type="text" name="studentLname1" id="studentLname1" value="" placeholder="Ex:Ramanan"
                        autocomplete="off" required>
                    <br><br>
                    <label id="lab">Class Name</label>
                    <input type="text" name="className1" placeholder="Ex:Computer Science" value="" id="className1"
                        autocomplete="off" required>
                    <br><br>
                    <label id="lab">MobileNumber</label>
                    <input type="text" name="studentMob1" placeholder="Ex:9876543210" value="" id="studentMob1"
                        autocomplete="off" required>
                    <br><br>
                    <label id="lab">MailId</label>
                    <input type="text" name="studentMail1" placeholder="Ex:ram123@gmail.com" value="" autocomplete="off"
                        id="studentMail1" required>
                    <br><br>
                    <label id="lab">Address</label>
        ...
        <div id="addstaffDiv" style="text-align: center;display: none;">
            ...
            <form class="addstaffform" id="addStaff" method="post">
                <div class="form-group">
                    ...
                    <input type="text" name="staffFname" id="staffFname" value="" placeholder="Ex:Akshay"
                        autocomplete="off" required>
                    <br><br>
                    <label id="lab">Staff Last Name</label>
                    <input type="text" name="staffLname" id="staffLname" value="" placeholder="Ex:Prasath"
                        autocomplete="off" required>
                    <br><br>
                    <label id="lab"> Subject Name</label>
                    <input type="text" name="subject" placeholder="Ex:Maths" value="" id="subject" autocomplete="off"
                        required>
                    <br><br>
                    <label id="lab">MobileNumber</label>
                    <input type="text" name="staffMob" placeholder="Ex:8520147960" value="" id="staffMob"
                        autocomplete="off" required>
                    <br><br>
                    <label id="lab">MailId</label>
                    <input type="text" name="staffMail" placeholder="Ex:akshay123@gmail.com" value="" autocomplete="off"
                        id="staffMail" required>
                    <br><br>
                    <label id="lab">Address</label>
                    <input type="text" name="staffAddress" id="staffAddress" value="" placeholder="Ex:chennai"
                        autocomplete="off" required>
                    <br><br>

                    <input class="btn btn-success" id="submitButton" type="submit" value="SAVE"
                        onclick="saveStaff(event)" style="margin-left: 0px;">
                    <button type="reset" style="margin-right: 16px" class="btn btn-danger">Clear</button>
        ...
        <div id="editstaffDiv" style="text-align: center;display: none;">
            ...
            <form class="editstaffform" id="editStaff" method="post">
                <div class="form-group">
                    <label id="lab">Staff First Name</label>
                    <input type="text" name="staffFname1" id="staffFname1" value="" placeholder="Ex:Akshay"
                        autocomplete="off" required>
                    <br><br>
                    <label id="lab">Staff Last Name</label>
                    <input type="text" name="staffLname1" id="staffLname1" value="" placeholder="Ex:Prasath"
                        autocomplete="off" required>
                    <br><br>
                    <label id="lab"> Subject Name</label>
                    <input type="text" name="subject1" placeholder="Ex:Maths" value="" id="subject1" autocomplete="off"
                        required>
                    <br><br>
                    <label id="lab">MobileNumber</label>
                    <input type="text" name="staffMob1" placeholder="Ex:8520147960" value="" id="staffMob1"
                        autocomplete="off" required>
                    <br><br>
                    <label id="lab">MailId</label>
                    <input type="text" name="staffMail1" placeholder="Ex:akshay123@gmail.com" value=""
                        autocomplete="off" id="staffMail1" required>
                    <br><br>
                    <label id="lab">Address</label>
                    <input type="text" name="staffAddress1" id="staffAddress1" value="" placeholder="Ex:chennai"
                        autocomplete="off" required>
                    <br><br>
